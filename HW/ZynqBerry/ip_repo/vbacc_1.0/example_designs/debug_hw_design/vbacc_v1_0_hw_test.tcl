# Runtime Tcl commands to interact with - vbacc_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/vbacc_v1_0_include.tcl
...
# Test: S00_AXI_CFG
# Create a write transaction at s00_axi_cfg_addr address
create_hw_axi_txn w_s00_axi_cfg_addr [get_hw_axis $jtag_axi_master] -type write -address $s00_axi_cfg_addr -data $wdata_1
# Create a read transaction at s00_axi_cfg_addr address
create_hw_axi_txn r_s00_axi_cfg_addr [get_hw_axis $jtag_axi_master] -type read -address $s00_axi_cfg_addr
# Initiate transactions
run_hw_axi r_s00_axi_cfg_addr
run_hw_axi w_s00_axi_cfg_addr
run_hw_axi r_s00_axi_cfg_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s00_axi_cfg_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - S00_AXI_CFG"
} else {
	puts "Data comparison test fail for - S00_AXI_CFG, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
...
# Test: M00_AXI_STATUS
set wdata_m00_axi_status [get_init_data 0]
create_hw_axi_txn w_m00_axi_status_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m00_axi_status}
create_hw_axi_txn r_m00_axi_status_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m00_axi_status_addr
run_hw_axi w_m00_axi_status_addr
run_hw_axi r_m00_axi_status_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m00_axi_status_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M00_AXI_STATUS"
} else {
	puts "Data comparison test fail for - M00_AXI_STATUS, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
