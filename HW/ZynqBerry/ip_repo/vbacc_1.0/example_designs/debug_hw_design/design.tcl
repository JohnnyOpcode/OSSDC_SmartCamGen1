...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of vbacc_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins vbacc_0/S00_AXI_CFG]
	connect_bd_net [get_bd_pins vbacc_0/s00_axi_cfg_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins vbacc_0/s00_axi_cfg_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of vbacc_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins vbacc_0/M00_AXI_STATUS]
	connect_bd_net [get_bd_pins vbacc_0/m00_axi_status_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins vbacc_0/m00_axi_status_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins vbacc_0/m00_axi_status_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins vbacc_0/m00_axi_status_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins vbacc_0/m00_axi_status_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]

	# Connect all clock & reset of vbacc_0 streaming interfaces..
	connect_bd_net [get_bd_pins vbacc_0/s00_axis_video_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins vbacc_0/s00_axis_video_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins vbacc_0/m00_axis_video_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins vbacc_0/m00_axis_video_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of vbacc_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {vbacc_0/M00_AXI_STATUS/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M00_AXI_STATUS_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells vbacc_0]

	# Copy all address to vbacc_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/vbacc_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_vbacc_0_S00_AXI_CFG_* ]]
	puts $fp "set s00_axi_cfg_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/vbacc_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "vbacc_v1_0_hw_${i}"
