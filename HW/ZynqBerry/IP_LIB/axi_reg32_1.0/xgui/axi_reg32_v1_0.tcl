...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set Read_Registers [ipgui::add_page $IPINST -name "Read Registers" -display_name {Input Registers}]
  ipgui::add_param $IPINST -name "C_NUM_RO_REG" -parent ${Read_Registers} -widget comboBox
  #Adding Group
  set Input_Registe_Alias [ipgui::add_group $IPINST -name "Input Registe Alias" -parent ${Read_Registers} -display_name {Input Register Alias}]
  ipgui::add_param $IPINST -name "C_RR0_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR1_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR2_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR3_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR4_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR5_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR6_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR7_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR8_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR9_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR10_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR11_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR12_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR13_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR14_ALIAS" -parent ${Input_Registe_Alias}
  ipgui::add_param $IPINST -name "C_RR15_ALIAS" -parent ${Input_Registe_Alias}
  ...
  #Adding Group
  set Register_Aliases [ipgui::add_group $IPINST -name "Register Aliases" -parent ${Output_Registers} -display_name {Output Register Alias}]
  ipgui::add_param $IPINST -name "C_WR0_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR1_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR2_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR3_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR4_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR5_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR6_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR7_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR8_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR9_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR10_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR11_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR12_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR13_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR14_ALIAS" -parent ${Register_Aliases}
  ipgui::add_param $IPINST -name "C_WR15_ALIAS" -parent ${Register_Aliases}


  #Adding Page
  set Default_values [ipgui::add_page $IPINST -name "Default values"]
  set_property tooltip {Output registers default values} ${Default_values}
  ipgui::add_param $IPINST -name "C_WR0_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR1_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR2_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR3_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR4_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR5_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR6_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR7_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR8_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR9_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR10_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR11_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR12_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR13_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR14_DEFAULT" -parent ${Default_values}
  ipgui::add_param $IPINST -name "C_WR15_DEFAULT" -parent ${Default_values}
