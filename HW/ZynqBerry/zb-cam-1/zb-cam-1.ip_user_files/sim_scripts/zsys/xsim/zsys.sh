...
xv_path="C:/Xilinx/SDx/2016.4/Vivado"
...
{
  file="xsim.ini"
  lib_map_path="C:/Xilinx/SDx/2016.4/Vivado/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
