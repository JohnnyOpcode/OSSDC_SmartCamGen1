...
proc create_hier_cell_video_out { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk clk_100mhz_in
  ...
  set_property -dict [ list \
   ...
   CONFIG.MMCM_CLKIN1_PERIOD {9.750} \
  ...
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axis_fb_conv_0/s_axis_aclk] [get_bd_pins clk_wiz_1/s_axi_aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/s_axi_aclk]
  ...
  connect_bd_net -net clk_in1_1 [get_bd_pins clk_100mhz_in] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins Video_IO_2_HDMI_TMDS_0/video_clk2x_in] [get_bd_pins clk_wiz_1/clk_out2]
  connect_bd_net -net clk_wiz_1_clk_out3 [get_bd_pins Video_IO_2_HDMI_TMDS_0/video_clk10x_in] [get_bd_pins clk_wiz_1/clk_out3]
...
proc create_hier_cell_video_in { parentCell nameHier } {
  ...
  # Create instance: axis_video_resize_0, and set properties
  set axis_video_resize_0 [ create_bd_cell -type ip -vlnv trenz.biz:user:axis_video_resize:1.0 axis_video_resize_0 ]
  ...
  connect_bd_intf_net -intf_net axis_raw_demosaic_0_M_AXIS [get_bd_intf_pins axis_raw_demosaic_0/M_AXIS] [get_bd_intf_pins axis_video_resize_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_raw_unpack_0_M_AXIS [get_bd_intf_pins axis_raw_demosaic_0/S_AXIS] [get_bd_intf_pins axis_raw_unpack_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_video_resize_0_M_AXIS [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_video_resize_0/M_AXIS]
  ...
  connect_bd_net -net csi_to_axis_0_data_err [get_bd_pins csi2_d_phy_rx_0/data_err] [get_bd_pins csi_to_axis_0/data_err]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins ext_reset_in] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net m_axi_aclk [get_bd_pins m_axis_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins axis_raw_demosaic_0/m_axis_aclk] [get_bd_pins axis_raw_demosaic_0/s_axis_aclk] [get_bd_pins axis_raw_unpack_0/m_axis_aclk] [get_bd_pins axis_raw_unpack_0/s_axis_aclk] [get_bd_pins axis_video_resize_0/m_axis_aclk] [get_bd_pins axis_video_resize_0/s_axis_aclk]
  connect_bd_net -net m_axis_aresetn_1 [get_bd_pins axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_data_fifo_0/m_axis_aresetn] [get_bd_pins axis_raw_demosaic_0/m_axis_aresetn] [get_bd_pins axis_raw_demosaic_0/s_axis_aresetn] [get_bd_pins axis_raw_unpack_0/m_axis_aresetn] [get_bd_pins axis_raw_unpack_0/s_axis_aresetn] [get_bd_pins axis_video_resize_0/m_axis_aresetn] [get_bd_pins axis_video_resize_0/s_axis_aresetn]
  connect_bd_net -net ref_clk_in_1 [get_bd_pins ref_clk_in] [get_bd_pins csi2_d_phy_rx_0/in_delay_clk]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {102.564102} \
   ...
   CONFIG.PCW_ACT_SDIO_PERIPHERAL_FREQMHZ {102.564102} \
   ...
   CONFIG.PCW_CLK1_FREQ {102564102} \
   ...
   CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR0 {13} \
   ...
   CONFIG.PCW_SDIO_PERIPHERAL_CLKSRC {ARM PLL} \
   CONFIG.PCW_SDIO_PERIPHERAL_DIVISOR0 {13} \
  ...
  # Create port connections
  connect_bd_net -net axi_reg32_0_WR0 [get_bd_pins axi_reg32_0/WR0] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_reg32_0/s_axi_aclk] [get_bd_pins processing_system7_0/DMA0_ACLK] [get_bd_pins processing_system7_0/DMA1_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins resets/axi_clk] [get_bd_pins video_in/m_axis_aclk] [get_bd_pins video_out/aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins video_out/clk_100mhz_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins video_in/ref_clk_in]
